...
const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <BlurText
                word={"Consultoria Especializada\nem Inteligência Artificial"}
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Transforme seu negócio com soluções personalizadas de IA e consultoria especializada em machine learning. <span className="hidden sm:inline">A Decision One IA entrega implementação estratégica de IA para o crescimento empresarial.</span>
                </p>
            </Container>
            <Container delay={0.2}>
